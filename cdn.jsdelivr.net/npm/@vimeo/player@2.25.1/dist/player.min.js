/*! @vimeo/player v2.25.1 | (c) 2025 Vimeo | MIT License | https://github.com/vimeo/player.js */ ! function(e, t) {
    ...
    function S() {
        ...
        if (O(this, "_id", "_WeakMap_" + N() + "." + N()), 0 < arguments.length) throw new TypeError("WeakMap iterable is not supported")
    }
    ...
    function F(e) {
        return Object(e) === e
    }(P = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : "undefined" != typeof window ? window : M).WeakMap || (T = Object.prototype.hasOwnProperty, _ = Object.defineProperty && function() {
        try {
    ...
    function H(a, e, t) {
        ...
        return new Promise(function(t, n) {
            if (!g(a)) throw new TypeError("“".concat(a, "” is not a vimeo.com url."));
            var e = function(e) {
            ...
            for (var o in u) u.hasOwnProperty(o) && (r += "&".concat(o, "=").concat(encodeURIComponent(u[o])));
            var i = new("XDomainRequest" in window ? XDomainRequest : XMLHttpRequest);
            i.open("GET", r, !0), i.onload = function() {
                if (404 !== i.status)
                    if (403 !== i.status) try {
                        var e = JSON.parse(i.responseText);
                        if (403 === e.domain_status_code) return B(e, c), void n(new Error("“".concat(a, "” is not embeddable.")));
                        t(e)
                    } catch (e) {
                        n(e)
            ...
            function Player(u) {
                ...
                var r, o = new A(function(i, a) {
                    ...
                    c._onMessage = function(e) {
                        ...
                        var t, n, r, o = B(e, u);
                        return c.element = o, c._originalElement = u, t = u, n = o, r = R.get(t), R.set(n, r), R.delete(t), Z.set(c.element, c), e
                    }).catch(a)
                });
                return K.set(this, o), Z.set(this.element, this), "IFRAME" === this.element.nodeName && W(this, "ping"), ee.isEnabled && (r = function() {
                    return ee.exit()
            ...
            return e(Player, [{
                ...
                value: function() {
                    ...
                    return new A(function(e) {
                        var t;
                        K.delete(n), Z.delete(n.element), n._originalElement && (Z.delete(n._originalElement), n._originalElement.removeAttribute("data-vimeo-initialized")), n.element && "IFRAME" === n.element.nodeName && n.element.parentNode && (n.element.parentNode.parentNode && n._originalElement && n._originalElement !== n.element.parentNode ? n.element.parentNode.parentNode.removeChild(n.element.parentNode) : n.element.parentNode.removeChild(n.element)), n.element && "DIV" === n.element.nodeName && n.element.parentNode && (n.element.removeAttribute("data-vimeo-initialized"), (t = n.element.querySelector("iframe")) && t.parentNode && (t.parentNode.parentNode && n._originalElement && n._originalElement !== t.parentNode ? t.parentNode.parentNode.removeChild(t.parentNode) : t.parentNode.removeChild(t))), n._window.removeEventListener("message", n._onMessage), ee.isEnabled && ee.off("fullscreenchange", n.fullscreenchangeHandler), e()
                    })
                }
            }, {
                key: "getAutopause",
